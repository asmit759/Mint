  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-indigo-950 flex items-center justify-center px-4 lg:px-8">
      <div className="flex w-full max-w-6xl gap-8 items-center">
        ...
        {/* LEFT - Branding Section with Framer Motion */}
        <motion.div 
        ...
        >
          ...
          >
            ...
            <motion.img 
              src={Logo} 
              alt="MINT Logo" 
              className="w-48 h-48 relative z-10 drop-shadow-2xl scale-200 "
              whileHover={{
          ...
          >
            ...
            <p className="text-gray-500 text-xs">
              @MINT all rights reserved 2025
            </p>
          </motion.div>
        </motion.div>

        {/* RIGHT - Login Form with entrance animation */}
        <motion.div 
