...
const {requestLeave,renderParentForm,verifyParentApproval,approveLeave,getLeaves,deleteLeave} = require("../controllers/leaveController")
...
leaveRouter.delete("/:id",mentorMid,isMentor,deleteLeave);
